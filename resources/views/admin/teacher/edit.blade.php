...
@endphp
<!-- Page Title -->
@section('title', 'تعديل بيانات المدرس : ' . $row->name)

<!-- Header Nav Title -->
@section('nav', 'الرئيسية')

<!-- Header SubNav Title -->
@section('sub_nav', 'تعديل بيانات المدرس : ' . $row->name))
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">تعديل بيانات المدرس : {{ $row->name }}</div>
                </div>
                <form class="card-body" action="{{ URL::route('admin.teacher.update',$row->id) }}" method="POST">
                    @csrf
                    @method('patch')
